"""
Django settings for muxuewang project.
...
SECRET_KEY = 'k(tb%0$s6dnxxh=ley_+ca$t+n5hmtz=#3vqu2==3i==yu((n%'
...
AUTH_USER_MODEL = "users.UserProfile"      #  修改django自带的 User表 要添加这个路径
