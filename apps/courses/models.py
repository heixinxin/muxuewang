...
class Course(models.Model):
    ...
    image = models.ImageField(upload_to="course/%Y/%m/%d/", verbose_name=u"封面图", max_length=100)
    click_nums = models.IntegerField(default=0, verbose_name=u"点击数")
    category = models.CharField(default='后端开发', null=True, blank=True, max_length=20, verbose_name=u"课程类别")
    ...
    def go_to(self):
        ...
        return  mark_safe("<a href='http://www.xuyunxin.xyz'>跳转</a>")
...
class BannerCourse(Course):
    class Meta:
        verbose_name = u"轮播课程"
        verbose_name_plural = verbose_name
        # proxy必须加 不然他会生成两张表 而不是同一个model 两个管理器了
        proxy = True
...
class CourseResource(models.Model):
    ...
    download = models.FileField(upload_to="course/resource/%Y/%m/%d", verbose_name=u"资源文件", max_length=100)
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
